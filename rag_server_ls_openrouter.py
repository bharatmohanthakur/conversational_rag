...
# OpenRouter client for LLM chat completions (wrapped with LangSmith tracing)
openrouter_client = wrap_openai(OpenAI(
...
# --- LLM Client for Agent ---
# Switched to standard ChatOpenAI for OpenRouter compatibility
